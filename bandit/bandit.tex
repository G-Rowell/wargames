...
\lstset{ %Src: https://tex.stackexchange.com/questions/499219/remove-ugly-space-under-lstlisting
    ...
    morekeywords={ssh, ls, less, grep, find, sort, uniq, strings, base64
    				, tr, mktemp, file, xxd, zcat, bzcat, tar}
}

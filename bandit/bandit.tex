...
\chall The file is prepended by a '.', which causes it to be hidden from most views. The \textit{-A} flag for \textbf{ls} will show all hidden files bar '.' \& '..', which are part of the directory itself.
\begin{lstlisting}
ls -A1
\end{lstlisting}
